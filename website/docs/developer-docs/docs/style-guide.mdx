...
When writing about a status or anything that is causal ("this happened because of that"), use the word "because". Use the word "since" for time-based docs (this will be rare in technical writing).
...
- Use the **imperative verb form** in procedural docs, not gerunds. For example, use "Configure your instance" instead of "Configuring your instance."
